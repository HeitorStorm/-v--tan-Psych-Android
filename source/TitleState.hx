	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				case 1:
					#if PSYCH_WATERMARKS
					createCoolText(['V-Tan Port Android'], 15);
					#else
					createCoolText(['Anonymous', 'Jacaris', 'Dude0216', 'Three Angled Blue']);
					#end
				// credTextShit.visible = true;
				case 3:
					#if PSYCH_WATERMARKS
					addMoreText('MarielyDev', 15);
					addMoreText('HeitorStorm', 15);
					addMoreText('Nothinglol', 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
				...
				case 5:
					#if PSYCH_WATERMARKS
					createCoolText(['From the degenerates', 'at'], -40);
					#else
					createCoolText(['In association', 'with'], -40);
					#end
				case 7:
					addMoreText('Funkg', -40);
					ngSpr.visible = true;
				// credTextShit.text += '\nNewgrounds';
				case 8:
					deleteCoolText();
				...
				// credTextShit.text += '\nNight';
				case 15:
					addMoreText('Fankan'); // credTextShit.text += '\nFunkin';
